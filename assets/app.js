            ...
            <div class="card-body" style="padding:10px 15px;">
                ${standingOrders.map(so => {
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom:5px; ${style}">
                        ...
                        ${(true) ? `
                        <button class="btn-icon text-danger" onclick="openEndStandingOrderModal('${p.id}', '${so.id}')" title="Bearbeiten/Beenden" aria-label="Dauerauftrag bearbeiten oder beenden" style="background:none; border:none; padding:4px;">
